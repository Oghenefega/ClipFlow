 ...
 */
// ─── Auto-capitalization ──────────────────────────────────────────────
// Whisper emits lowercase "i'm" / "oh my god" / "jesus". The rules live in
// subtitleCasing.js (#368) — shared with the main process, which applies them
// at birth — and run here for clips already on disk so editor, preview, and
// final render all see identical text. The caller gates this behind
// !hasEditorSavedSubs: once the user saves edits, their casing is
// authoritative and never rewritten. Idempotent.
const autoCapitalizeWords = fixWordCasing;
